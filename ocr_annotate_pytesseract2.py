...
from scenetext import SceneTextOCR
...
if __name__ == "__main__":
    ...
    # OCR on image using SceneOCR
    result = ocr.detect_and_recognize(img)
    
    # Convert SceneOCR result to list format for processing
    ocr_results = []
            ...
            if text and bbox and len(bbox) >= 4:
                ...
                if bbox_is_coords:
                    ...
                    normalized_bbox = bbox
                      ...
                      all(isinstance(pt, (list, tuple)) and len(pt) == 2
                          for pt in bbox)):
                    # Convert from [[x1,y1], [x2,y2], [x3,y3], [x4,y4]]
                ...
                ocr_results.append((normalized_bbox, text, conf))
